...
Program_date = "{0:%B} {0:%Y} (Dec 2009 LADR)".format(datetime.now())
...
Feedback = (
    "\nIf you have feedback, please file an issue "
    "at https://github.com/laitep/Prover9-Mace4-GUI/issues. "
    "We are especially interested in making this system "
...
class Main_frame(wx.Frame):
    ...
    def __init__(self, parent, title, size, pos):
        ...
        self.box_font = wx.Font(
            12, wx.FONTFAMILY_MODERN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL
        )
