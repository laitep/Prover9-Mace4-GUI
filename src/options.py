...
class M4_options:
    ...
    options = [
        ...
        [
            ...
            0,
            [0, sys_maxsize],
            "Look for structures of this size only.",
        ],
        [
            None,
            None,
        ...
        [
            ...
            "Domain sizes must satisfy this property.",
        ],
        [
            None,
            None,
            ...
            1,
            [-1, sys_maxsize],
            "Stop search at this number of models (-1 means no limit).",
        ],
        [
            None,
            None,
        ...
        [
            ...
            -1,
            [-1, sys_maxsize],
            "Time limit for each domain size.",
        ],
        [
            None,
            None,
            ...
            None,
            (
                "Variables start with upper case instead of starting with"
                " u,v,w,x,y,z."
            ),
        ],
        ...
        [
            ...
            0,
            None,
            "Impose a ring structure (see sample input Ring-19.in).",
        ],
        ...
        [
            ...
            200,
            [-1, sys_maxsize],
            "Memory limit for Mace4 process (approximate).",
        ],
        [
            None,
            None,
        ...
        [
            ...
            1,
            None,
            "Negative propagation is triggered by assignments.",
        ],
        [
            None,
            None,
            ...
            1,
            None,
            "Negative propagation is triggered by near-assignments.",
        ],
        [
            None,
            None,
            ...
            1,
            None,
            "Negative propagation is triggered by eliminations.",
        ],
        [
            None,
            None,
            ...
            1,
            None,
            "Negative propagation is triggered by near-eliminations.",
        ],
        [
            None,
            None,
            ...
            2,
            [0, 2],
            "0: all, 1: concentric, 2: concentric-band.",
        ],
        [
            None,
            None,
            ...
            [0, 4],
            (
                "0: first, 1: most occurrences, 2: most propagations, 3: most"
                " contradictions, 4: fewest values."
            ),
        ],
    ]
    ...
    def __init__(self, parent, logo_bitmap):
        ...
        self.options_panel = Options_panel(
            self.panel, "Mace4 Options", logo_bitmap, self.options
        )
        # mark dependencies
...
class P9_options:
        ...
        (
            ...
            [
                [
                    ...
                    None,
                    100,
                    [-sys_maxsize, sys_maxsize],
                    "Discard inferred clauses with weight greater than this.",
                ],
                [
                    None,
                    None,
                    ...
                    -1,
                    [-1, sys_maxsize],
                    "Selection by (Weight : Age) ratio  (except for hints).",
                ],
                [
                    None,
                    None,
                    ...
                    ["lpo", "rpo", "kbo"],
                    (
                        "Overall term ordering: Lexicographic Path Ordering"
                        " (LPO), Recursive Path Ordering (RPO), Knuth-Bendix"
                        " Ordering (KBO).  If the search fails with LPO, try"
                        " KBO."
                    ),
                ],
                [
                    ...
                    ["unfold", "fold", "pass"],
                    (
                        "Adjustment of term ordering, based on equational"
                        " definitions in the input.\nUnfold: eliminate defined"
                        " operations at the start of the search;\nFold:"
                        " introduce the defined operation whenever"
                        " possible;\nPass: let equational definitions be"
                        " oriented by the term ordering."
                    ),
                ],
                [
                    None,
                    ...
                    None,
                    (
                        "Use relational definitions in the input to immediately"
                        " expand occurrences of the defined relations in the"
                        " input."
                    ),
                ],
                [
                    ...
                    None,
                    (
                        "This flag restricts the application of inference rules"
                        " when negative clauses are involved, with the goal of"
                        " producing more direct (forward) proofs.  WARNING:"
                        " this flag can block proofs."
                    ),
                ],
                [
                    None,
                    ...
                    [-1, sys_maxsize],
                    (
                        "Stop the search at this number of seconds (CPU, not"
                        " wall clock)."
                    ),
                ],
                [
                    ...
                    None,
                    (
                        "Variables start with upper case instead of starting"
                        " with u,v,w,x,y,z."
                    ),
                ],
            ],
        ...
        (
            ...
            [
                [
                    ...
                    None,
                    (
                        "Automatic Mode.  This flag simply sets or clears the"
                        " following 4 flags."
                    ),
                ],
                [
                    ...
                    1,
                    None,
                    "Processing before the search starts.",
                ],
                [
                    None,
                    None,
                ...
                [
                    ...
                    None,
                    (
                        "Automatic handling of denials (negative clauses in"
                        " Horn sets)."
                    ),
                ],
                [
                ...
                [
                    ...
                    1,
                    None,
                    "Processing of inferred clauses.",
                ],
                [
                    None,
                    None,
        ...
        (
            ...
            [
                ...
                [
                    ...
                    None,
                    (
                        "Adjustment of term ordering, based on occurrences of"
                        " inverse axioms in the input."
                    ),
                ],
            ],
        ),
        (
            ...
            [
                ...
                [
                    ...
                    -1,
                    [-1, sys_maxsize],
                    "Stop the search at this number of given clauses.",
                ],
                [
                    None,
                    None,
                ...
                [
                    ...
                    [-1, sys_maxsize],
                    (
                        "Stop the search when the process has used about this"
                        " amount of memory."
                    ),
                ],
                [
                ...
                [
                    ...
                    -1,
                    [-1, sys_maxsize],
                    "Discard inferred clauses with depth greater than this.",
                ],
                [
                    None,
                    None,
                    ...
                    -1,
                    [-1, sys_maxsize],
                    "Discard inferred clauses with more literals than this.",
                ],
                [
                    None,
                    None,
                ...
                [
                    ...
                    [-1, sys_maxsize],
                    (
                        "Limit on the size of the SOS list (the list of clauses"
                        " that have been kept, but not yet selected as given"
                        " clauses).  As the SOS fills up, a heuristic is used"
                        " to discards new clauses that are unlikely to be used"
                        " due to this limit."
                    ),
                ],
        ...
        (
            ...
            [
                ...
                [
                    ...
                    None,
                    (
                        "Do not flip input equalities, even if they violate the"
                        " term ordering.  Using this flag can cause"
                        " nontermination of rewriting.  It is usually better to"
                        " adjust the term ordering instead."
                    ),
                ],
                [
                    None,
                    ...
                    None,
                    (
                        "Treat input clauses as if they were inferred;"
                        " exceptions are the application of max_weight,"
                        " max_level, max_vars, and max_literals."
                    ),
                ],
                [
                    None,
                    ...
                    None,
                    (
                        "Sort the initial assumptions.  The order is largely "
                        " arbitrary."
                    ),
                ],
                [
                    ...
                    None,
                    (
                        "Try to eliminate predicate (relation) symbols before"
                        " the search starts."
                    ),
                ],
                [
        ...
        (
            ...
            [
                [
                    ...
                    None,
                    (
                        "This flag applies only to Horn sets.  It restricts the"
                        " application of inference rules when negative clauses"
                        " are involved, with the goal of producing more direct"
                        " (forward) proofs."
                    ),
                ],
                [
                    ...
                    None,
                    (
                        "This flag allows multiple proofs of goals.  (Applies"
                        " to Horn sets only."
                    ),
                ],
            ],
        ...
        (
            ...
            [
                ...
                [
                    ...
                    sys_maxsize,
                    [0, sys_maxsize],
                    "Component for clauses that match hint.",
                ],
                [
                    None,
                    None,
                ...
                [
                    ...
                    0,
                    [0, sys_maxsize],
                    "Component for the lightest clauses.",
                ],
                [
                    None,
                    None,
                    ...
                    [0, sys_maxsize],
                    (
                        "Component for the lightest false (w.r.t. an"
                ...
                [
                    ...
                    [0, sys_maxsize],
                    (
                        "Component for the lightest true (w.r.t. an"
                        " interpretation) clauses."
                    ),
                ],
                [
                ...
                [
                    ...
                    0,
                    None,
                    "Random selection (except for hints).",
                ],
                ...
                [
                    ...
                    (
                        "Semantics with multiple interpretaions: determines how"
                        ' clauses are marked as "false".'
                    ),
                ],
                [
                    None,
                    ...
                    [-1, sys_maxsize],
                    (
                        "Limit on the number of ground instances for evaluation"
                        " in an explicit interpretation (for semantic"
                        " guidance)."
                    ),
                ],
                ...
                [
                    ...
                    0,
                    None,
                    "For hints component, select by age rather than by weight.",
                ],
            ],
        ),
        (
            ...
            [
                ...
                [
                    ...
                    0,
                    None,
                    "Binary resolution (not necessarily positive).",
                ],
                [
                    None,
                    None,
                ...
                [
                    ...
                    0,
                    None,
                    "Synonym for pos_hyperresolution.",
                ],
                [
                    None,
                    None,
                ...
                [
                    ...
                    0,
                    None,
                    "Positive-unit resulting resolution.",
                ],
                [
                    None,
                    None,
                    ...
                    0,
                    None,
                    "Negative-unit resulting resolution.",
                ],
                [
                    None,
                    None,
                    ...
                    0,
                    None,
                    "The inference rule for equality.",
                ],
                ...
                [
                    ...
                    [-1, sys_maxsize],
                    (
                        "If > 0, introduce new constants when equations such as"
                        " x*x'=y*y' are derived.  The value of this parameter"
                        " is a limit on the number of times the rule will be"
                        " applied."
                    ),
                ],
                ...
                [
                    ...
                    None,
                    "max_negative",
                    ["max_negative", "all_negative", "none"],
                    (
                        "Method for determining which literals in a"
                        " multi-literal clause are eligible for resolution or"
                        " paramodulation."
                    ),
                ],
                [
                ...
                [
                    ...
                    None,
                    (
                        "Resolved literals in one or more parents must be"
                        " maximal in the clause.  (Does not apply to UR"
                        " resolution.)"
                    ),
                ],
                [
                    ...
                    None,
                    (
                        "The maximality checks are done after the application"
                        " of the unifier for the inference."
                    ),
                ],
                [
                    None,
                    ...
                    None,
                    (
                        "For hyperresolution and UR resolution the nucleus for"
                        " the inference must be an initial clause (this"
                        " restriction can block all proofs)."
                    ),
                ],
                [
                    None,
                    ...
                    [-1, sys_maxsize],
                    (
                        "The nucleus for each UR-resolution inference can have"
                ...
                [
                    ...
                    None,
                    (
                        "For paramodulation inferences, one or both parents"
                        " must be maximal in the clause."
                    ),
                ],
                [
                    None,
                ...
                [
                    ...
                    None,
                    (
                        "Paramodulation is allowed from variables (not allowing"
                        " can block all proofs).."
                    ),
                ],
                [
                    None,
                    ...
                    None,
                    (
                        "Paramodulation is applied to unit clauses only (this"
                        " restriction can block all proofs)."
                    ),
                ],
                ...
                [
                    ...
                    [-1, sys_maxsize],
                    (
                        "Paramodulation is not applied to clauses with more"
                        " than this number of literals (using this restriction"
                        " can block all proofs)."
                    ),
                ],
            ],
        ...
        (
            ...
            [
                ...
                [
                    ...
                    [-1, sys_maxsize],
                    (
                        "When rewriting derived clauses, apply at most this"
                        " many rewrite steps.  Under most settings, rewriting"
                        " is guaranteed to terminate, but it can be"
                        " intractable."
                    ),
                ],
                [
                    ...
                    [-1, sys_maxsize],
                    (
                        "When rewriting derived clauses, stop if the term being"
                ...
                [
                    ...
                    None,
                    (
                        "Apply non-orientable equations as rewrite rules if the"
                        " instance used for the rewrite is orientable."
                    ),
                ],
                [
                    None,
                    ...
                    None,
                    (
                        "This is a restriction on lex_dep_demod.  A"
                        " non-orientable equation can be used for rewriting"
                        " only if the two sides have the same number of"
                        " symbols."
                    ),
                ],
                [
                    ...
                    (
                        "This is a restriction on lex_dep_demod.  A"
                        " non-orientable equation can be used for rewriting"
                        " only if it has fewer than this number of symbols."
                    ),
                ],
                [
                    None,
                    ...
                    None,
                    (
                        "Incorporate (uninstantiated) variables into the term"
                        " ordering, treating them as constants.  For example,"
                        " x*y < y*x.  This cuts down the search, but it can"
                        " block all proofs."
                    ),
                ],
                ...
                [
                    ...
                    1,
                    None,
                    "Use newly derived equations to rewrite old clauses.",
                ],
                [
                    None,
                    None,
                    ...
                    None,
                    (
                        "Remove literals from newly derived clauses with old"
                        " unit clauses, and use newly derived unit clauses to"
                        " remove literals from old clauses."
                    ),
                ],
                [
                    None,
                    ...
                    None,
                    (
                        "Eliminate some redundancy when there are commutative"
                        " or associative-commutative operations."
                    ),
                ],
            ],
        ),
        (
            ...
            [
                ...
                [
                    ...
                    0,
                    [-sys_maxsize, sys_maxsize],
                    "Weight of the disjunction symbol.",
                ],
                [
                    None,
                    None,
                    ...
                    [-sys_maxsize, sys_maxsize],
                    (
                        "Weight of Skolem constants.  This option can be"
                        " useful, because Skolem constants cannot appear in"
                        " weighting rules."
                    ),
                ],
                [
                ...
                [
                    ...
                    [0, sys_maxsize],
                    (
                        "If a term contains a (non-constant) Skolem function,"
                ...
                [
                    ...
                    [0, sys_maxsize],
                    (
                        "For each nest of two identical function symbols, e.g.,"
                        " f(f(x,y),z), this value is added tot he weight of the"
                        " term."
                    ),
                ],
                [
                    ...
                    [-sys_maxsize, sys_maxsize],
                    (
                        "After the weight of clause C is calculated, its weight"
                        " is increased by depth(C) * this_value."
                    ),
                ],
                [
                    None,
                    ...
                    (
                        "After the weight of clause C is calculated, its weight"
                        " is increased by number_of_vars(C) * this_value."
                    ),
                ],
                [None, None, None, None, Group, "Others", "right"],
                [
        ...
        (
            ...
            [
                [
                    ...
                    None,
                    (
                        "In some cases, a proof may be missed because a"
                        " newly-derived clause is deleted by a limit such as"
                        " max_weight.  This flag eliminates some of those"
                        " cases."
                    ),
                ],
                [
                    ...
                    None,
                    (
                        "When a newly-derived clause C is kept, discard all old"
                ...
                [
                    ...
                    (
                        ...
                        " subsumption if less than 5% of kept clauses have been"
                        " back subsumed."
                    ),
                ],
            ],
        ...
        (
            ...
            [
                ...
                [
                    ...
                    None,
                    (
                        "Show clauses after preprocessing, before the start of"
                        " the search."
                    ),
                ],
                [
                    ...
                    None,
                    (
                        "Print clauses when they are selected as given clauses."
                        "  These clauses say a lot about the progress of the"
                        " search."
                    ),
                ],
                [
                    ...
                    None,
                    (
                        "Print all newly-derived clauses.  This flag can cause"
                        " an enormous amount of output for nontrivial searches."
                    ),
                ],
                [
                    None,
                    ...
                    None,
                    (
                        "Print newly-derived clauses if they pass the retention"
                        " tests."
                    ),
                ],
                [
                    ...
                    0,
                    None,
                    "Print newly-kept clauses that have labels.",
                ],
                [
                    None,
                    None,
                    ...
                    1,
                    None,
                    "Print all proofs that are found.",
                ],
                ...
                [
                    ...
                    None,
                    (
                        "When a clause is printed, show some if its syntactic"
                ...
                [
                    ...
                    ["none", "some", "lots", "all"],
                    (
                        "How many statistics should be printed at the end of"
        ...
        (
            ...
            [
                [
                    ...
                    None,
                    (
                        "Apply the parameters max_weight, max_vars, max_depth,"
                        " and max_literals to clauses that match hints (as well"
                        " as to those that do not match hints)."
                    ),
                ],
                [
                    None,
                    ...
                    None,
                    (
                        "When equivalent hints are input, only the first is"
                        " kept.  This flag causes any labels on the discarded"
                        " hints to be appended to the retained hint."
                    ),
                ],
                [
                    None,
                    ...
                    None,
                    (
                        "The more times a hint is matched, the less its effect"
                        " becomes."
                    ),
                ],
                [
                    ...
                    None,
                    (
                        "This flag causes hints, as well as ordinary clauses,"
                        " to be rewritten by newly-derived equations."
                    ),
                ],
            ],
        ),
    ...
    dependencies = [
        ...
        (("auto_limits", False), ("max_weight", sys_maxsize)),
        ...
        (("raw", True), ("backsub_check", sys_maxsize)),
...
def set_options(opt_str, opt_class, handle_dep=True):
    ...
    pat_parm = (  # without period
        "assign\s*\(\s*([a-z0-9_]+)\s*,\s*([a-z0-9_-]+)\s*\)"
    )
